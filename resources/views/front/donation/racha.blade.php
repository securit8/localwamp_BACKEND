...
<div class = "container-fluid moiare_cont pt-1 px-0">
  <img class = "w-100" src = "{{ asset('front/assets/images/racha_banner.png') }}" alt="banner picture" />
  <img class = "moiare_logo" src ="{{ asset('front/assets/images/racha_logo.png') }}" />
</div>
...
<div class ="container-fluid background_banner racha_back p-0">
...
<div class = "container">
  ...
  <div class = "col-12 background_moiare">
    ...
    <div class = "col-12 moiare_heading d-flex justify-content-between">
      <div class ="   col-lg-10 col-md-8 col-sm-7 col-6 turi_head">ტურის ღირებულება ერთ ადამიანზე ორადგილიან ნომერში </div><div class ="span">640<span style="color:black;font-size:1rem;">ლ</span></div><span class ="" style="margin-right:35px;color:black;">-დან</span>
    </div>
    ...
    <div class = "col-12 mt-5 p-5 moiare_desc ">
      ...
      <p>-საუზმე სასტუმროში</p>
      <p>-შაორის წყალსაცავი, ნიკორწმინდა</p>
      <p>-ბარაკონის ტაძარი</p>
      <p>-ტური ამბროლაურში</p>
      <p>-ღვინის დეგუსტაცია, მასტერკლასები</p>
      <p>-ფოლკ შოუ და ვახშამი</p>
