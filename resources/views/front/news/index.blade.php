...
<div class="container p-0">
  <div class="container-fluid p-0 py-3">
   ...
   <div class="col-3 first_col">
     <div class = "col-12 ">
        <a href = "{{ route('donation.vianotbilisi') }}"  class = "car_img"><img src = "{{ asset('front/assets/images/vcls.jpg') }}" style="width:100%; " alt = "bene-cars.jpg" /><img class = "car_title" src = "{{ asset('front/assets/images/TOYOTACAMRY.png') }}" style = "width:100%;visibility: hidden;position:absolute;top:0;left:0;"/></a>
     </div>

     <div class = "col-12 my-1">
         <a href = "{{ route('donation.sprinter11') }}"  class = "car_img"><img src = "{{ asset('front/assets/images/sprnt.jpg') }}" style="width:100%;" alt = "bene-cars.jpg" /><img class = "car_title" src = "{{ asset('front/assets/images/TOYOTACAMRY.png') }}" style = "width:100%;visibility: hidden;position:absolute;top:0;left:0;"/></a>
     </div>

     <div class = "col-12 ">
         <a href = "{{ route('donation.camry') }}"  class = "car_img"><img src = "{{ asset('front/assets/images/camry.jpg') }}" style="width:100%;position:relative;" alt = "bene-cars.jpg" /><img class = "car_title" src = "{{ asset('front/assets/images/TOYOTACAMRY.png') }}" style = "width:100%;visibility: hidden;position:absolute;top:0;left:0;"/></a>
     </div>
   </div>

   <div class="col-6">
     <div class = "col-12 px-1">
       <a href = "{{ route('donation.maybach') }}" class = "car_img"><img src = "{{ asset('front/assets/images/mybch.png') }}" style="width:100%;" alt = "bene-cars.jpg" /></a>
     </div>
     <div class = "col-12 pt-1 d-flex justify-content-around">
       <div class = "col-6 " style="padding-left:4px;padding-right:2px;" >
        <a href = "{{ route('donation.sclass') }}" class = "car_img"><img src = "{{ asset('front/assets/images/scls1.jpg') }}" style="width:100%;" alt = "bene-cars.jpg" /><img class = "car_title" src = "{{ asset('front/assets/images/TOYOTACAMRY.png') }}" style = "width:100%;visibility: hidden;position:absolute;top:0;left:0;"/></a>
       </div>
       <div class = "col-6 " style="padding-right:4px;padding-left:2px;" >
        <a href = "{{ route('donation.eclass') }}" class = "car_img"><img src = "{{ asset('front/assets/images/ecls1.jpg') }}" style="width:100%;" alt = "bene-cars.jpg" /><img class = "car_title" src = "{{ asset('front/assets/images/TOYOTACAMRY.png') }}" style = "width:100%;visibility: hidden;position:absolute;top:0;left:0;"/></a>
       </div>
     </div>
   </div>
   ...
   <div class="col-3">
     <div class = "col-12">
        <a href = "{{ route('donation.landCruiser') }}" class = "car_img"><img src = "{{ asset('front/assets/images/toyotaland.jpg') }}" style="width:100%;" alt = "bene-cars.jpg" /><img class = "car_title" src = "{{ asset('front/assets/images/TOYOTACAMRY.png') }}" style = "width:100%;visibility: hidden;position:absolute;top:0;left:0;"/></a>
     </div>

     <div class = "col-12 py-1">
         <a href = "{{ route('donation.sprinter16') }}" class = "car_img" ><img src = "{{ asset('front/assets/images/sprnt.jpg') }}" style="width:100%;" alt = "bene-cars.jpg" /><img class = "car_title" src = "{{ asset('front/assets/images/TOYOTACAMRY.png') }}" style = "width:100%;visibility: hidden;position:absolute;top:0;left:0;"/></a>
     </div>

     <div class = "col-12">
         <a href = "{{ route('donation.lx450') }}" class = "car_img"><img src = "{{ asset('front/assets/images/lx.jpg') }}" style="width:100%;" alt = "bene-cars.jpg" /><img class = "car_title" src = "{{ asset('front/assets/images/TOYOTACAMRY.png') }}" style = "width:100%;visibility: hidden;position:absolute;top:0;left:0;"/></a>
     </div>
   </div>
      </div>
    </div>
